    ...
    <div id="app" class="flex h-screen bg-gray-50 dark:bg-gray-900" user="{{ auth()->user()->id ?? 0 }}"
        ...
        <transition enter-class="opacity-100" enter-to-class="opaccity-100" leave-class="transition ease-in"
            ...
            <div v-if="this.isLoad"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16" xmlns:xlink="http://www.w3.org/1999/xlink" style="display: block; shape-rendering: auto;" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                    <circle cx="50" cy="50" fill="none" stroke="#4f46e5" stroke-width="10" r="35" stroke-dasharray="164.93361431346415 56.97787143782138">
