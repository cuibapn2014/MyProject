                            ...
                            <form action="{{ route('request.login') }}" method="POST">
                                ...
                                <label class="block text-sm">
                                    ...
                                    <input
                                        ...
                                        name="email" placeholder="ex@example.com" value="{{ old('email') }}" />
                                </label>
                                ...
                                <div class="py-2 flex items-center">
                                    <input class="w-4 h-4 accent-indigo-600 rounded-md checked:bg-indigo-400"
                                        type="checkbox" name="remember" id="chk_remember" />
                                    <label class="mx-1 text-[#ffffff] lg:text-black dark:text-gray-200" for="chk_remember">Nhớ tôi</label>
                                </div>
