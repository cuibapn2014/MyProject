...
<div class="container px-6 mx-auto grid">
    ...
    <div class="flex justify-end py-2">
        ...
        <button onclick="location.href='{{ route('admin.ingredient.create') }}?type=1'"
        ...
        <button onclick="location.href='{{ route('admin.ingredient.export') . '?type=2' }}'"
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3 text-sm flex items-center">
                            <button v-tooltip="'Chỉnh sửa'" title="Chỉnh sửa"
                                ...
                                aria-label="Edit"
                                onclick="location.href='{{ route('admin.ingredient.update',['id' => $ingredient->id]) }}?type=1'">
