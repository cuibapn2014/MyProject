...
@section('title', 'Thêm mới |Nhập kho')
@section('main')
@php
$current = 10;
@endphp
<div class="container px-6 mx-auto grid">
    ...
    <form action="{{ route('admin.warehouse.import.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <warehouse-import :products="{{ json_encode($products) }}" quick_code="{{ $code }}"></warehouse-import>
    </form>
</div>
      ...
      " id="backdrop-overlay" @click="handleClickBackDrop">
        ...
        " role="dialog" id="modal">
                ...
                <footer
                    ...
                    <a href="{{ route('admin.warehouse.import.index') }}"
