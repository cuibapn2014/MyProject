...
<div class="container px-6 mx-auto grid">
    ...
    @endif
    <form action="{{ route('admin.warehouse.import.update', ['id' => $import->id]) }}" method="post" enctype="multipart/form-data">
        @csrf
        <warehouse-import :product_update="{{ json_encode($import) }}" :products="{{ json_encode($products) }}"></warehouse-import>
