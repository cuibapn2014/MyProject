...
<div class="container px-6 mx-auto grid">
    ...
    <div class="flex justify-end py-2">
        ...
        <button onclick="location.href='{{ route('admin.customer.create') }}'"
            ...
            <table class="w-full whitespace-no-wrap">
                ...
                <thead>
                    <tr
                        ...
                        <th class="px-4 py-3">Thêm bởi</th>
                ...
                <tbody class="bg-[#ffffff] divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3 text-sm">
                            <img v-tooltip.top-start="'{{ $customer->user->name }}'"
                                src="{{asset('/img/user').'/'.$customer->user->image}}"
                        ...
                        <td class="px-4 py-3 text-sm flex items-center">
                            <button v-tooltip="'Chỉnh sửa'" title="Chỉnh sửa"
                                onClick="location.href='{{ route('admin.customer.update',['id' => $customer->id]) }}'"
                            ...
                            <button v-tooltip="'Xóa'" title="Xóa" @click="openModal({{ $customer->id }})"
                                :key="{{$customer->id}}"
                                class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                aria-label="Delete">
                                <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
      ...
      " id="backdrop-overlay" @click="handleClickBackDrop">
        ...
        " role="dialog" id="modal">
            ...
            " aria-label="close" @click="closeModal">
                ...
                <div class="mt-4 mb-6">
                    ...
                    <p class="text-sm text-gray-700 dark:text-gray-400">
                        Bạn có chắc chắn muốn xóa nhà khách hàng này ?
                    </p>
                </div>
                <footer class="
            flex flex-col
          ...
          ">
            ...
            " @click='handleDelete("/admin/customer/delete/")'>
                        Chắc chắn
                    </button>
