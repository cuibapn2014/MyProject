        ...
        <div class="px-4 py-3 mb-8 bg-[#ffffff] rounded-lg shadow-md dark:bg-gray-800">
            <label class="block text-sm">
                ...
                <input
                    ...
                    placeholder="Nhập mã chi phí" type="text" name="code" value="{{ $finance->code }}" />
            </label>
            <label class="block text-sm mt-2">
                ...
                <input
                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                    placeholder="Nhập tên chi phí" name="title" value="{{ $finance->title }}" />
            </label>
            <label class="block text-sm mt-3">
                ...
                <input
                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                    name="total" value="{{ $finance->total }}" type="number" step="1000" min="0"/>
            </label>
            <label class="block mt-4 text-sm">
                <span class="text-gray-700 dark:text-gray-400">Nội dung</span>
                <textarea
                    class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                    rows="3" placeholder="Nhập nội dung" name="detail">{{ $finance->detail }}</textarea>
            </label>
            <label class="block text-sm mt-3">
                ...
                <input
                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                    name="create_date" type="date" value="{{ \Carbon\Carbon::parse($finance->create_date)->toDateString() }}"/>
            </label>
