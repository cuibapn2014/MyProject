...
<div
    class="bg-gradient-to-r h-11 overflow-hidden duration-150 relative from-sky-500 to-indigo-500 mx-4 my-2 text-white p-2 rounded-lg">
    ...
    <ul class="list-disc font-semibold mx-4">
        ...
        <li class="my-2">Quản lý khách hàng - Theo dõi thông tin của khách hàng <span
