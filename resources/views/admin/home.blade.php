    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div class="flex items-center p-4 bg-[#ffffff] rounded-lg shadow-xs dark:bg-gray-800">
            ...
            <div>
                ...
                <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                    {{ number_format_str($financeTotal->spent) }} <sup>đ</sup>
                </p>
            </div>
        </div>
        <div class="flex items-center p-4 bg-[#ffffff] rounded-lg shadow-xs dark:bg-gray-800">
            ...
            <div>
                ...
                <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                    {{ number_format_str($financeTotal->earn) }} <sup>đ</sup>
                </p>
            </div>
        </div>
        <div class="flex items-center p-4 bg-[#ffffff] rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div class="flex items-center p-4 bg-[#ffffff] rounded-lg shadow-xs dark:bg-gray-800">
            ...
            <div>
                ...
                <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                    {{ number_format($productionRequest) }}
                </p>
            </div>
        </div>
        <div class="flex items-center p-4 bg-[#ffffff] rounded-lg shadow-xs dark:bg-gray-800">
